      ...
      <div>
        <div className="flex items-center justify-between mb-1.5">
          ...
          >
            ...
            <span>{isVi ? 'Tải bài văn mẫu' : 'Load Sample Essay'}</span>
          </button>
        </div>
        ...
        <textarea
          ...
          className="w-full px-4 py-3 bg-neutral-900 border border-neutral-800 rounded-xl text-sm text-white placeholder-neutral-500 focus:outline-none focus:border-sky-500 transition-colors leading-relaxed font-sans"
        />
      </div>
    </div>
  );
